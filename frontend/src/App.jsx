      ...
      <Box component="main" sx={{ flexGrow: 1 }}>
        <Routes>
          ...
          <Route
            element={
              <ProtectedRoute
                allowedRoles={["reader", "author", "librarian"]}
              />
            }
          >
          ...
          {/* Author Routes */}
          <Route
            element={<ProtectedRoute allowedRoles={["author", "librarian"]} />}
          >
            <Route path="/author/dashboard" element={<AuthorDashboard />} />
            <Route path="/author/materials" element={<MyMaterialsPage />} />
            <Route
              path="/author/materials/create"
              element={<MaterialFormPage />}
            />
            <Route
              path="/author/materials/:id/edit"
              element={<MaterialFormPage />}
            />
