...
class EmailService {
      ...
      html: `
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #eee; padding: 20px; border-radius: 10px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <h1 style="color: #043A82; margin: 0;">BookNest</h1>
          </div>
          <h2 style="color: #10B981; border-bottom: 2px solid #10B981; padding-bottom: 10px;">Welcome Aboard!</h2>
          <p>Hello <strong>${name}</strong>,</p>
          <p>We are pleased to inform you that your registration at BookNest has been <strong>approved</strong> by our librarian.</p>
          ...
          <p style="text-align: center; color: #999; font-size: 0.8em;">Happy reading,<br>The BookNest Team</p>
        </div>
      `,
    };
  ...
  async sendPasswordResetEmail(to, name, newPassword) {
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM,
      to,
      subject: "Temporary Password - BookNest",
      html: `
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #eee; padding: 20px; border-radius: 10px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <h1 style="color: #043A82; margin: 0;">BookNest</h1>
          ...
          <hr style="border: 0; border-top: 1px solid #eee; margin: 20px 0;">
          <p style="text-align: center; color: #999; font-size: 0.8em;">Best regards,<br>The BookNest Team</p>
        </div>
      `,
    };
